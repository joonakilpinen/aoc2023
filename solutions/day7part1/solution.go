...
//    in an airship. (At least it's a cool airship!) It drops you off at the
...
//    so on up to the strongest hand. Because there are five hands in this
//    example, the strongest hand will have rank 5 and its bid will be
//    multiplied by 5.
//
